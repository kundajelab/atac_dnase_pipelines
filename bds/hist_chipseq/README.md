...
### Installation instruction for softwares for the hist chipseq pipeline

The histone chipseq pipeline shares almost the same softwares with the tf chipseq pipeline.

Look at <a href="../tf_chipseq/README_SW.md">../tf_chipseq/README_SW.md</a>
